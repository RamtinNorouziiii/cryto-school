...
const footer = () => {
  return (
    <div className=" relative">
      ...
      <div className=' h-10 py-8 px-4 border-t border-t-lightblue'>
        <h3 className='text-center text-offwhite'>@2023 - All Rights Reserved by <Link href="https://github.com/RamtinNorouziiii" target="_blank">RamtinNrzi</Link></h3>
      </div>
