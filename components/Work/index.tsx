...
const workdata: workdata[] = [
    {
        ...
        heading: ' ثبت نام در مدرسه کریپتو ',
        subheading: '',
        hiddenpara: '',
    },
    {
        imgSrc: '/images/Work/icon-two.svg',
        heading: 'دیدن دوره ها',
        subheading: '',
        hiddenpara: '',
    },
    {
        imgSrc: '/images/Work/icon-three.svg',
        heading: 'کسب درآمد دلاری',
        subheading: '',
        hiddenpara: '',
    },
...
const Work = () => {
    return (
        <div>
            <div className='mx-auto max-w-7xl mt-48 px-6 mb-20 relative'>
                <div className="radial-bgone hidden lg:block"></div>
                <div className='text-center mb-14'>
                    <h3 className='text-offwhite text-3xl md:text-3xl font-bold mb-3'> وظیفه مدرسه کریپتو </h3>
